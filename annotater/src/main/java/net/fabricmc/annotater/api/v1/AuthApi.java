package net.fabricmc.annotater.api.v1;
...
import net.fabricmc.annotater.api.util.Attributes;
import net.fabricmc.annotater.api.util.Role;
...
import net.fabricmc.annotater.auth.RefreshTokenController;
